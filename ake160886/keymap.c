...
const uint16_t PROGMEM keymaps[] [MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    KC_MSEL,KC_MPLY,KC_MUTE,   	      KC_F1,KC_F2,KC_F3,KC_F4,KC_F5,KC_F6,KC_F7,KC_F8,KC_F9,KC_F10,KC_F11,KC_F12,NO,NO,		NO,   NO,   NO,   	NO,   KC_CALC,   NO,   KC_WAKE,
    KC_MPRV,KC_MNXT,KC_VOLD,KC_VOLU,  KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, NO, NO,NO,NO,  		NO,   NO,   NO,   	KC_PWR,   BTC,   NO,   KC_SLEP,

    AF1,AF2,AF3,AF4,	      	      ESC,  KC_INSERT,   KC_HOME,KC_END, KC_PGUP, KC_PGDOWN,   NO,   NO,   NO,   NO, 		KC_WHOM,KC_WSCH,      	KC_NLCK,   NO,   NO,   KC_PSLS,
    ...
    NMAP,DIRB,   NO,   NO,   	      KC_LSFT, KC_INSERT,Z,X,  C,    V,    B,    N,M,KC_COMM,KC_DOT,KC_SLSH,KC_GRAVE,KC_RSFT, 	NO,   NO,   NO,		KC_KP_1,   KC_KP_2,   KC_KP_3,   KC_KP_PLUS,
