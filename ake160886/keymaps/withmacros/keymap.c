...
const uint16_t PROGMEM keymaps[] [MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    AF1,    AF2,    AF3,    AF4,      KC_ESC,  COPY, PSTE,   KC_HOME,KC_END, KC_PGUP, KC_PGDOWN,   NO,   NO,   NO, 							KC_WHOM,KC_WSCH,      	 KC_NLCK, NO,	     NO,   	KC_PSLS,
    AF5,    AF6,    AF7,    AF8,      KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, NO,  	KC_WBAK,KC_UP,KC_WFWD,	 KC_KP_7, KC_KP_8,   KC_KP_9,   KC_KP_ASTERISK,
    AF9,    AF10,   AF11,   AF12,     KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, NO,KC_ENT, 		KC_LEFT,KC_DOWN,KC_RGHT, KC_KP_4, KC_KP_5,   KC_KP_6,   KC_KP_MINUS,
    NMAP,   DIRB,   NO,     FNCY,     KC_LSFT, NO ,     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,KC_GRAVE,KC_RSFT,  	NO, 	KC_WFAV,NO,	 KC_KP_1, KC_KP_2,   KC_KP_3,   KC_KP_PLUS,
