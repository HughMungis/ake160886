...
const uint16_t PROGMEM keymaps[] [MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    KC_MPRV,KC_MNXT,KC_VOLD,KC_VOLU,  KC_1, KC_2, KC_3, KC_4, KC_5, KC_6,   KC_7, KC_8, KC_9, KC_0, 	  KC_NO,    KC_NO,    KC_NO,KC_NO,  					KC_BRID,   KC_NO,   KC_NO,   	 KC_PWR,BTC, KC_NO,KC_SLEP,

    AF1,    AF2,    AF3,    AF4,      KC_ESC,  COPY, PSTE,   KC_HOME,KC_END, KC_PGUP, KC_PGDOWN,   KC_NO,   KC_NO,   KC_NO, 							KC_WHOM,KC_WSCH,      	 	 KC_NLCK, KC_NO,	     KC_NO,   	KC_PSLS,
    ...
    NMAP,   DIRB,   KC_NO,  FNCY,     KC_LSFT, KC_NO ,     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,KC_GRAVE,KC_RSFT,  		KC_NO, 	KC_WFAV,KC_NO,	 	 KC_KP_1, KC_KP_2,   KC_KP_3,   KC_KP_PLUS,
